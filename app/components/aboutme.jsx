...
export default function aboutme() {
  return (
    <div className=" flex  justify-center  mb-20 mt-10 gap-50 place-items-center  items-center max-sm:mb-10 max-sm:gap-10 max-sm:flex-col max-sm:place-items-center max-md:flex-col max-md:gap-10">
