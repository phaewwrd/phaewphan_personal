    ...
    <div className="flex flex-col">
      ...
      <div className=" p-10  flex place-items-center  ">
        <div className="flex flex-col gap-5">
          ...
          <div>are software tools that assist in planning, designing, developing, testing, and managing projects. They improve efficiency, accuracy, and teamwork throughout the project lifecycle.
          ...
          <div className="flex gap-5 justify-start mt-10 ">
            ...
            <div className="flex gap-5">
              {/* frontend */}
              <button
                className="bg-slate-900 text-white px-4 py-2 rounded-md flex gap-2 "
