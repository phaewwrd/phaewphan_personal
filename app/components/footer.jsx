...
export default function Footer() {
  return (
    <div className="shadow-2xl border-2 flex justify-end max-sm:justify-center place-items-center pt-20 pb-10 h-full border-slate-50">
      <div className="flex pr-10 flex-col gap-5  ">
        ...
        <a href="tel:+66621456941" className="text-orange-600 font-bold">+66 62 1456941</a>
        </div>
        <div className="flex gap-2 ">
        ...
        <a href="mailto:phaewphan.wrd@gmail.com" className="text-orange-600 font-bold"> phaewphan.wrd@gmail.com</a>
        </div>
        <div className="flex gap-2 ">
        ...
        <a href="https://github.com/phaewwrd" className="text-orange-600 font-bold">Github : phaewphan.wrd</a>
        </div>
      </div>
      {/* <div className="flex w-100  flex-col gap-2 items-start m-10">
        <div className="flex gap-2 ">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-phone-icon lucide-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        <a href="tel:+66621456941" className="text-orange-600 font-bold">+66 62 1456941</a>
        </div>
      ...
      {/* <div className="w-full h-60 absolute -z-10 flex justify-end ">
        <Image
          src="/images/bg02.jpg"
          alt="languages"
          width={1000}
