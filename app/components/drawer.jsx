...
export default function page() {
  return (
    <div className="absolute right-0 top-19 z-10 pt-10 pb-5 bg-white w-80 shadow-xl rounded-2xl h-fullflex flex-col gap-5">
       <div className="flex w-100 flex-col gap-5 p-5">
        ...
        <a href="https://github.com/phaewwrd" className="text-orange-600 font-bold">phaewphan.wrd</a>
        </div>
      </div>
    </div>
  );
