    ...
    <div className="m-20 flex flex-col text-lg justify-center place-items-center gap-5 ">
      <div className="flex flex-col gap-10 font-semibold w-250  p-15 max-sm:w-90 max-sm:p-5 max-md:w-150">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="font-medium">
            Tattoo Studio & Clothing Brand | 2024 – Present
          </div>
          <div className="font-medium">
            - Managed end-to-end business operations, client communications, and
            vendor coordination <br />
            - Planned and executed projects from concept to delivery under tight
            timelines <br />
            - Built digital presence and handled online marketing and customer
            engagement <br />- Developed workflows and tracked performance for
        ...
        <div className="flex gap-10 max-sm:flex-col max-sm:gap-5 max-md:flex-col">
          ...
          <div className=" pt-10 shadow-xl p-10 rounded-2xl border-slate-200 w-100 ">
            ...
            <div className="font-semibold">
              Faculty of Architecture and Design | Bachelor Degree of Fine Arts,{" "}
            </div>
          ...
          <div className="p-5 pt-10 shadow-xl rounded-2xl border-slate-200 w-100 ">
            ...
            <div>
              <div className="font-semibold">Upskill UX</div> Become a UX
              Designer From Scratch #3
            </div>
          </div>
          {/* 2024 */}
          <div className="p-5 pt-10 shadow-xl  rounded-2xl border-slate-200 w-100 ">
            ...
            <div className="font-medium">
              <div className="font-semibold">Software Park </div>CodeCamp
              Thailand #19 Bangkok, Thailand <br /> Full Stack Web Development
              Course
            </div>
            <div className="font-medium">
              <div className="font-semibold">Google</div>Foundations of Project
              Management
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5 font-semibold p-15 w-250  rounded-2xl shadow-xl bg-white max-sm:w-90 max-md:w-120">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="font-medium">
              ...
              Office, Google Sheets, PowerPoint <br />- Research Tools: FigJam
            </div>
          </div>
          <div className="flex flex-col gap-2">
            Development Tools:
